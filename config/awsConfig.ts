...
if (!accessKeyId) {
    throw new Error("AWS access key id is not defined in the environment variables.");
}

if (!secretAccessKey) {
    throw new Error("AWS secret access key is not defined in the environment variables.");
}
